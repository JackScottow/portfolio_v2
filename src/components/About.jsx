...
import { faReact, faSquareJs, faNodeJs, faCss3, faHtml5, faGithub } from "@fortawesome/free-brands-svg-icons";
      ...
      <div className="px-10 mx-auto my-auto max-w-7xl lg:py-auto lg:px-auto">
        <div className="lg:grid lg:grid-cols-2 lg:items-center lg:gap-8">
          <div>
            ...
            <p className="max-w-3xl mt-3 text-lg text-gray-300">Hi there! I&apos;m Jack, a front-end developer based near London specialising in React. I have expertise in a wide range of web technologies and I&apos;m passionate about creating beautiful and functional websites. Whether you&apos;re looking for a website revamp or a brand new build, I offer the necessary skills to meet your needs. Feel free to check out some of my work!</p>
          </div>
