...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className={`${isMobileDrawerOpen ? "translate-y-0 top-0" : " -translate-y-full -top-full"} fixed  right-0 bg-slate-900 text-gray-100 h-fit w-full transition-transform duration-250 ease-in-out border-b-2 border-b-teal-100">  z-40`}>
