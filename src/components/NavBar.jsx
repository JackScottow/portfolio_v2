      ...
      <aside className="sticky top-0 flex-col justify-between flex-shrink-0 hidden w-64 h-screen text-gray-300 border-r bg-slate-900 md:flex border-r-teal-300">
        ...
        <div className="flex py-3 justify-evenly">
          <Link href="https://github.com/JackScottow" target="_blank" alt="github">
            <FontAwesomeIcon icon={faGithub} size="xl" className="transition duration-200 ease-in hover:text-teal-300 hover:scale-125" />
          </Link>

          <Link href="https://twitter.com/jms__1991" target="_blank" alt="twitter">
            <FontAwesomeIcon icon={faTwitter} size="xl" className="transition duration-200 ease-in hover:text-teal-300 hover:scale-125" />
          </Link>

          <Link href="https://www.instagram.com/jackms91" target="_blank" alt="instagram">
            <FontAwesomeIcon icon={faInstagram} size="xl" className="transition duration-200 ease-in hover:text-teal-300 hover:scale-125" />
          </Link>

          <Link href="https://www.linkedin.com/in/jack-scottow/" target="_blank" alt="linkedin">
            <FontAwesomeIcon icon={faLinkedin} size="xl" className="transition duration-200 ease-in hover:text-teal-300 hover:scale-125" />
          </Link>

          <Link href="mailto:j.scottow@gmail.com" target="_blank" alt="email">
            <FontAwesomeIcon icon={faEnvelopeOpen} size="xl" className="transition duration-200 ease-in hover:text-teal-300 hover:scale-125" />
          </Link>
        </div>
      </aside>
